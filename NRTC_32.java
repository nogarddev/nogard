public class NRTC_32 {
    ...
    public static String north = "NRTC_33";
    public static String east = "NRTC_42";
    public static String south = "NRTC_31";
    public static String west = "NRTC_22";
