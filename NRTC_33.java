public class NRTC_33 {
    ...
    public static String north = "NRTC_34";
    public static String east = "NRTC_43";
    public static String south = "NRTC_32";
    public static String west = "NRTC_23";
