public class NRTC_24 {
    public static final String[] movement_commands = {"east","south","west"};
    public static String up = "empty";
    public static String down = "empty";
    public static String north = "empty";
    public static String east = "NRTC_34";
    public static String south = "NRTC_23";
    public static String west = "NRTC_14";
