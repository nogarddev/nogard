...
//                                System.out.println("adsasdf");
    ...
    public static void pause_menu() {
        ...
        while (choice.equals("1") == false) {
            pause_draw();
            choice = choices(false, "30", true, new String[]{"1","2","3","4"});
            if (choice.equals("2")) {
                exit_to_menu = true;
                return;
            }
    ...
    public static Boolean exit_to_menu = false;
