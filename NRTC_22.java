public class NRTC_22 {
    ...
    public static String north = "NRTC_23";
    public static String east = "NRTC_32";
    public static String south = "NRTC_21";
    public static String west = "NRTC_12";
